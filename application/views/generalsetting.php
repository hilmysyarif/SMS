								...
								<div class="form-group-separator"></div>
										...
										<div class="form-group col-md-4">
												...
												<div class="col-sm-8">
													<div class="input-group">
														<input type="text" readonly class="form-control datepicker" data-format="D, dd MM yyyy" name="soft_date" value="<?=date("d-m-Y",$school_info[0]->SchoolStartDate)?>">
									...
									<div class="form-group col-md-4">
										...
										<div class="form-group col-md-4">
											...
											<div class="col-sm-7">
												<input type="text" class="form-control datepicker" id="field-1"  name="doe" readonly value="<?=date("d-m-Y",$school_info[0]->DateOfEstablishment)?>">
											</div>
										</div>
										</div>
