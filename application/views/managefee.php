									...
									<div class="panel-body">
											...
											<?php } ?>
																...
																<div class="form-group">
																	...
																	<option value="<?=$classinfo->SectionId?>" <?php if(empty($id)==''){ $cal_id=$fee_update[0]->SectionId;  $cal_id=explode(',',$cal_id); foreach($cal_id as $val){ echo (!empty($val==$classinfo->SectionId) ? "selected" : ''); }} ?>><?=$classinfo->ClassName?> <?=$classinfo->SectionName?></option>
																			<?php } ?>
																		</optgroup>
																		</select>
																</div>	
