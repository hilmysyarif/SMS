...
/*school management Home Work List view Load................................................................................................*/
	...
	function evaluationofhomework($classid=false,$sectionid=false,$subjectid=false,$datehome=false){
		if(Authority::checkAuthority('OnlineExamList')==true){
		...
		$this->breadcrumb->clear();
		$this->breadcrumb->add_crumb('Evaluate Home Work', base_url().'homework/evaluationofhomework');
		
		if(!empty($classid) && !empty($sectionid) && !empty($subjectid) && !empty($datehome)){
			$this->data['classid']=$classid;
			$this->data['sectionid']=$sectionid;
			$this->data['subjectid']=$subjectid;
			$this->data['datehome']=$datehome;
			$this->data['student'] = $this->homework_model->get_student(!empty($this->currentsession[0]->CurrentSession)?$this->currentsession[0]->CurrentSession:'',$sectionid);
		}
		...
		$this->parser->parse('include/topheader',$this->data);
		$this->parser->parse('include/leftmenu',$this->data);
		$this->load->view('evaluatehomework',$this->data);
		$this->parser->parse('include/footer',$this->data);
