...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 02, 2015 at 01:39 PM
...
`online_exam_id` int(11) NOT NULL,
  ...
  `online_exam_level` varchar(30) CHARACTER SET utf8 NOT NULL,
...
(87, 'Settings'),
(88, 'Balance')
(89, 'IncomeExpanceGraph')
(90, 'AdmissionPiechart');
...
(1, '1', 'masteruser', 'e10adc3949ba59abbe56e057f20f883e', 0, '', '', '');
...
--
ALTER TABLE `sibling`
MODIFY `SiblingId` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=2;
--
