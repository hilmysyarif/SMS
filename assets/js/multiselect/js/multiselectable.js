	...
	$.fn.multiselectable = function (options) {
		...
		options = $.extend({
			template: '<div class="multiselectable">' +
				...
				'<select name="absent[]" multiple="multiple" id="m-selectable"></select>' +
				'</div>' +
				...
				'<select multiple="multiple"  name="staff[]" id="m-selected"></select>' +
				'</div>' +
			'</div>',
			selectableLabel: 'Staff List:',
			selectedLabel: 'Marked Attendence:',
			moveRightText: '→',
			moveLeftText: '←',
			sort: true,
			sortAscending: true
